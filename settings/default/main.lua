...
xi.settings.main =
{
    ...
    GIL_RATE        = 1000.000, -- Multiplies gil earned from quests.  Won't always display in game.
    BAYLD_RATE      = 1.000, -- Multiples bayld earned from quests.
    -- Note: EXP rates are also influenced by conf setting
    EXP_RATE        = 3.000, -- Multiplies exp from script (except FoV/GoV).
    CAPACITY_RATE   = 3.000, -- Multiplies capacy points gained.
    ...
    TWO_HANDED_STR_ATTACK_MULTIPLIER         = 2.0,  -- 1.0: 1 STR = 1 Attack. This has been 0.5 and 0.75 in previous eras
    HAND_TO_HAND_STR_ATTACK_MULTIPLIER       = 2.0,  -- 1.0: 1 STR = 1 Attack. This has been 0.5 and 0.625 in previous eras.
    ONE_HAND_MAIN_HAND_STR_ATTACK_MULTIPLIER = 2.0, -- 0.75: 1 STR = 0.75 Attack. This has been 0.5 in previous eras.
    ONE_HAND_OFF_HAND_STR_ATTACK_MULTIPLIER  = 2.0,  -- 0.5: 1 STR = 0.5 Attack. This has always been 0.5 but is provided anyway.
    RANGED_STR_ATTACK_MULTIPLIER             = 2.0,  -- 1.0: 1 STR = 1.0 Ranged Attack. This has been 0.5 and 0.75 in previous eras.

    -- DEX:ACC ratios. For players only. Mobs are hardcoded to 0.5
    TWO_HANDED_DEX_ACCURACY_MULTIPLIER         = 2.0, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 and 0.75 in previous eras
    HAND_TO_HAND_DEX_ACCURACY_MULTIPLIER       = 2.0, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.
    ONE_HAND_MAIN_HAND_DEX_ACCURACY_MULTIPLIER = 2.0, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.
    ONE_HAND_OFF_HAND_DEX_ACCURACY_MULTIPLIER  = 2.0, -- 0.75: 1 DEX = 0.75 Accuracy. This has been 0.5 in previous eras.

    -- AGI:RACC ratio. Mobs are hardcoded to 0.5
    RANGED_AGI_ACCURACY_MULTIPLIER = 2.0, -- 0.75: 1 AGI = 0.75 Ranged Accuracy. This has been 0.5 in previous eras.

    -- VIT:DEF ratio. Applies to everything but mobs and charmed mobs. Those are hardcoded to 0.5.
    PLAYER_ALLIES_VIT_DEF_MULTIPLIER = 2.0, -- 1.5: 1 VIT = 1.5 DEF. This has been 0.5 in previous eras.
    ...
    HARVESTING_RATE         = 0, -- % chance to recieve an item from haresting.  Set between 0 and 100.
    EXCAVATION_RATE         = 0, -- % chance to recieve an item from excavation.  Set between 0 and 100.
    LOGGING_RATE            = 0, -- % chance to recieve an item from logging.  Set between 0 and 100.
    MINING_RATE             = 0, -- % chance to recieve an item from mining.  Set between 0 and 100.
    ...
    GARRISON_LOCKOUT       = 300,  -- Time in seconds before a new garrison can be started (default: 1800)
    ...
    -- LIMBUS SETTINGS
    COSMO_CLEANSE_BASE_COST     = 150,    -- Base gil cost for a Cosmo Cleanse from Sagheera
